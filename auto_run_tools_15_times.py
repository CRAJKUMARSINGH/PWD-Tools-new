"""
Script to automatically run each PWD tool 15 times programmatically with optimized inputs.
...
def main():
    ...
    print("This script will automatically run each tool 15 times with optimized inputs.")
    print()
    
    # Run all tools automatically
